...
- Forum page includes open jobs and a Logs tab showing completed jobs from the last 2 weeks.
- Admin settings page to manage forum users, create properties, assign users to properties, and configure per-property SMTP/IMAP + delivery/reporting settings.
...
- Each property has its own settings for receiving addresses, SMTP, IMAP, weekly report delivery, and job completion CC list.
